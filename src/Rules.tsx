  ...
  return (
    <div className="rules-screen">
      ...
      <div className="rules-section">
        ...
        <p className="rules-section-text">
          Défie un membre du groupe : chacun tire 3 penaltys pendant que l'autre garde les buts, puis les rôles s'inversent. Le tireur vise une zone, le gardien plonge sans savoir laquelle :
        </p>
        <ul className="rules-points">
      ...
      <div className="rules-section">
        ...
        <p className="rules-section-text">
          Duel à 10 questions contre un membre du groupe, 7 secondes pour répondre à chacune. Celui qui a le plus de bonnes réponses gagne :
        </p>
        <ul className="rules-points">
